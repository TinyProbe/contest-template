...
pub fn Vec(comptime T: type) type {
    return struct {
        ...
        pub fn appendNTimes( self: *Self, n: usize, item: u8) Allocator.Error!void {
        ...
        pub fn insertNTimes(self: *Self, pos: usize, n: usize, item: u8) Allocator.Error!void {
            try self.resize(self.items.len + n);
            std.mem.copyBackwards(
        ...
        pub fn replaceNTimes(self: Self, pos: usize, n: usize, item: u8) void {
            @memset(@ptrCast([*]u8, self.items.ptr + pos), item, @sizeOf(T) * n);
        }
